// generated
            ...
            ApiGetAllDevice,
            ApiGetFilterDevice,
            ApiGetSearchDevice,            ApiGetByIdDevice,
            ApiAddDevice,
            ApiEditDevice,
            ApiDeleteDevice
            ...
            ApiDeleteRole
                                                    ...
                                                    const { 
            ApiGetAllPlaceDevice,
            ApiGetFilterPlaceDevice,
                        ApiGetByIdPlaceDevice,
            ApiAddPlaceDevice,
            ApiEditPlaceDevice,
            ApiDeletePlaceDevice
        } = require("./controllers/placedevice");
                                                                const { 
...
app.get('/api/device/search', ApiGetSearchDevice.bind(ContextApi));
    ...
    app.delete('/api/role/:id', ApiDeleteRole.bind(ContextApi));
                                                // Получение всех записей
    app.get('/api/placedevice/all', ApiGetAllPlaceDevice.bind(ContextApi));

    // Получение записей по фильтру
    app.get('/api/placedevice/filter', ApiGetFilterPlaceDevice.bind(ContextApi));

    // Получение записи
    app.get('/api/placedevice/:id', ApiGetByIdPlaceDevice.bind(ContextApi));

    // Добавление записи
    app.post('/api/placedevice/0', ApiAddPlaceDevice.bind(ContextApi));

    // Редактирование записи
    app.put('/api/placedevice/:id', ApiEditPlaceDevice.bind(ContextApi));
    app.post('/api/placedevice/:id', ApiEditPlaceDevice.bind(ContextApi));

    // Удаление записи
    app.delete('/api/placedevice/:id', ApiDeletePlaceDevice.bind(ContextApi));
                                                            // Получение всех записей
