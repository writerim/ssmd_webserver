    ...
    ApiGetAllLastData (req, res, next) {
        ...
        this.isAuth(req, res).then(user => {
            ...
            return GetAllCountLastData(user_ctx).then(r_count => {
                return GetAllLastData({limit: Number(limit) , offset:Number(offset)},user_ctx).then(r => {
    ...
    ApiGetFilterLastData (req, res, next) {
        ...
        this.isAuth(req, res).then(user => {
            ...
            return GetAllByFilterCountLastData(filter, user_ctx).then(r_count => {
                return GetAllByFilterLastData(filter, {limit: Number(limit) , offset:Number(offset)}, user_ctx).then(r => {
...
*/
    ApiGetSearchLastData (req, res, next) {
        ...
        this.isAuth(req, res).then(user => {
            ...
            return GetAllSerachCountLastData(req.params.text, user_ctx).then(r_count => {
                return GetAllSerachLastData(req.params.text, {limit:Number(limit) , offset:Number(offset)},user_ctx).then(r => {
