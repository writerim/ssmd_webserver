    ...
    ApiGetAllPlace (req, res, next) {
        ...
        this.isAuth(req, res).then(user => {
            ...
            return GetAllCountPlace(user_ctx).then(r_count => {
                return GetAllPlace({limit: Number(limit) , offset:Number(offset)},user_ctx).then(r => {
    ...
    ApiGetSearchPlace (req, res, next) {
        ...
        this.isAuth(req, res).then(user => {
            ...
            return GetAllSerachCountPlace(req.params.text, user_ctx).then(r_count => {
                return GetAllSerachPlace(req.params.text, {limit:Number(limit) , offset:Number(offset)},user_ctx).then(r => {
