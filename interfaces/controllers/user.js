    ...
    console.log('ApiGetFilterUser');
        ...
        this.isAuth(req, res).then(user => {
            ...
            return GetAllByFilterCountUser(filter, user_ctx).then(r_count => {
                return GetAllByFilterUser(filter, {limit: Number(limit) , offset:Number(offset)}, flags, user_ctx).then(r => {
    ...
    console.log('ApiGetSearchUser');
        ...
        this.isAuth(req, res).then(user => {
            ...
            return GetAllSearchCountUser(req.params.text, user_ctx).then(r_count => {
                return GetAllSearchUser(req.params.text, f , flags, user_ctx).then(r => {
