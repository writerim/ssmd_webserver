...
*
* @apiBody {Number} id 
* @apiBody {Number} parent_id Родтельское устройство
...
* @apiSuccess {Number} parent_id Родтельское устройство
...
* @apiSuccess {Number} parent_id=true Родтельское устройство
* @apiSuccess {String} name Название
* @apiSuccess {Object} settings_connections Настройки подключения
...
* @apiSuccess {Number} data.parent_id Родтельское устройство
...
*/
    ...
    console.log('ApiGetFilterDevice');
        ...
        this.isAuth(req, res).then(user => {
            ...
            return GetAllByFilterCountDevice(filter, user_ctx).then(r_count => {
                return GetAllByFilterDevice(filter, {limit: Number(limit) , offset:Number(offset)}, flags, user_ctx).then(r => {
...
*/
    ...
    console.log('ApiGetSearchDevice');
        ...
        this.isAuth(req, res).then(user => {
            ...
            return GetAllSearchCountDevice(req.params.text, user_ctx).then(r_count => {
                return GetAllSearchDevice(req.params.text, f , flags, user_ctx).then(r => {
