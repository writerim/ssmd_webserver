    ...
    ApiGetFilterPlaceType (req, res, next) {
        ...
        this.isAuth(req, res).then(user => {
            ...
            return GetAllByFilterCountPlaceType(filter, user_ctx).then(r_count => {
                return GetAllByFilterPlaceType(filter, {limit: Number(limit) , offset:Number(offset)}, flags, user_ctx).then(r => {
...
*/
    ApiGetSearchPlaceType (req, res, next) {
        ...
        this.isAuth(req, res).then(user => {
            ...
            return GetAllSearchCountPlaceType(req.params.text, user_ctx).then(r_count => {
                return GetAllSearchPlaceType(req.params.text, f , flags, user_ctx).then(r => {
