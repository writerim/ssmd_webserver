    ...
    ApiGetAllData (req, res, next) {
        ...
        this.isAuth(req, res).then(user => {
            ...
            return GetAllCountData(user_ctx).then(r_count => {
                return GetAllData({limit: Number(limit) , offset:Number(offset)},user_ctx).then(r => {
    ...
    ApiGetFilterData (req, res, next) {
        ...
        this.isAuth(req, res).then(user => {
            ...
            return GetAllByFilterCountData(filter, user_ctx).then(r_count => {
                return GetAllByFilterData(filter, {limit: Number(limit) , offset:Number(offset)}, user_ctx).then(r => {
...
*/
    ApiGetSearchData (req, res, next) {
        ...
        this.isAuth(req, res).then(user => {
            ...
            return GetAllSerachCountData(req.params.text, user_ctx).then(r_count => {
                return GetAllSerachData(req.params.text, {limit:Number(limit) , offset:Number(offset)},user_ctx).then(r => {
