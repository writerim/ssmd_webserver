...
module.exports = {
    ...
    MapToGetResponsePlaceDevice : MapToGetResponse,
    MapToAddRequestPlaceDevice : MapToAddRequest,
    MapToAddResponsePlaceDevice : MapToAddResponse,
    MapToEditRequestPlaceDevice : MapToEditRequest,
    MapToEditResponsePlaceDevice : MapToEditResponse,
    MapToDeleteRequestPlaceDevice : MapToDeleteRequest,
    MapToDeleteResponsePlaceDevice : MapToDeleteResponse,
