...
module.exports = {
    ...
    MapToGetResponseRole : MapToGetResponse,
    MapToAddRequestRole : MapToAddRequest,
    MapToAddResponseRole : MapToAddResponse,
    MapToEditRequestRole : MapToEditRequest,
    MapToEditResponseRole : MapToEditResponse,
    MapToDeleteRequestRole : MapToDeleteRequest,
    MapToDeleteResponseRole : MapToDeleteResponse,
