...
module.exports = {
    ...
    MapToGetResponseUserPlace : MapToGetResponse,
    MapToAddRequestUserPlace : MapToAddRequest,
    MapToAddResponseUserPlace : MapToAddResponse,
    MapToEditRequestUserPlace : MapToEditRequest,
    MapToEditResponseUserPlace : MapToEditResponse,
    MapToDeleteRequestUserPlace : MapToDeleteRequest,
    MapToDeleteResponseUserPlace : MapToDeleteResponse,
